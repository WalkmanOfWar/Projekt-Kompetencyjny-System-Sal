...
const RoomFacilties = () => {
  const [roomFacilites, setRoomFacilities] = useState([]);
  ...
  const loadFacilities = async () => {
    const result = await axios.get('http://localhost:8080/room_facilities');
    setRoomFacilities(result.data);
  };
