...
function ControlPanel() {
  ...
  return (
    <div className="info-wrapper">
      ...
      <div className="button-group">
        <button className={`panel-button ${selectedButton === "User_courses" ? "selected" : ""}`} onClick={() => handleButtonClick("User_courses")}>Przedmioty prowadzących</button>
        <button className={`panel-button ${selectedButton === "Reservations" ? "selected" : ""}`} onClick={() => handleButtonClick("Reservations")}>Rezerwacje</button>
        <button className={`panel-button ${selectedButton === "Korekty" ? "selected" : ""}`} onClick={() => handleButtonClick("Korekty")}>Korekty</button>
        <button className={`panel-button ${selectedButton === "Generowanie" ? "selected" : ""}`} onClick={() => handleButtonClick("Generowanie")}>Generowanie</button>
      </div>
      {renderComponent()}
    </div>
  );
