...
export default function Navbar() {
  ...
  const handleReservationsDelete = async () => {
    try {
      await axios.delete('http://localhost:8080/deleteTestReservations');
      toast.success('Udalo sie usunac wszystkie rezerwacje');
    } catch (error) {
      console.log(error);
      toast.error('Nie udalo sie usunac wszystkich rezerwacji');
    }
  };
      ...
      <div className='container-fluid'>
        ...
        <div
          ...
          <ul className='navbar-nav ms-auto'>
            ...
            {/* <li className='nav-item nav-item-text'>
              <button onClick={handleReservationsDelete}>
                Zresetuj rezerwacje
              </button>
            </li> */}
            {renderUserAccount()}
