...
import ProfileAddReservation from '../components/ProfileAddReservation';
...
function Profile() {
  ...
  const handleClick = (component) => {
    ...
    switch (component) {
      ...
      case 'ProfileReservations':
        ...
        break;
      case 'ProfileAddReservation':
        setActiveSidebar('Dodaj rezerwację');
        break;
      case 'ControlPanel':
  ...
  const generateUserSidebar = () => {
    return (
      <>
        ...
        <span
          className={
            activeComponent === 'ProfileAddReservation' ? 'text active' : 'text'
          }
          onClick={() => handleClick('ProfileAddReservation')}>
          Dodaj rezerwację
        </span>
  ...
  const generateProfileContent = () => {
    return activeComponent === 'ProfileInfo' ? (
      ...
      <ProfileReservations />
    ) : activeComponent === 'ProfileAddReservation' ? (
      <ProfileAddReservation />
